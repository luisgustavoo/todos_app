...
abstract mixin class $TodoCopyWith<$Res> {
  factory $TodoCopyWith(Todo value, $Res Function(Todo) _then) =
      _$TodoCopyWithImpl;
  @useResult
  $Res call({String id, String description, bool isDone});
}
...
extension TodoPatterns on Todo {
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>(TResult Function(_Todo value) $default) {
    final _that = this;
    switch (_that) {
      case _Todo():
        return $default(_that);
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String description, bool isDone)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Todo() when $default != null:
        return $default(_that.id, _that.description, _that.isDone);
      case _:
        return orElse();
    }
  }
